...
CONTENT_STRUCTURES = {
    "progressive": """【内容组织原则 - 渐进式】

核心思想：从已知到未知，循序渐进

建议包含的要素（灵活安排，不必严格按顺序）：
- 前置知识回顾：建立与新知识的连接
- 新概念引入：动机、定义、直观理解
- 深入探究：推导、性质、边界条件
- 实例说明：从简单到复杂的案例
...
组织提示：根据内容自然流动，不要生硬分段。""",

    "case_driven": """【内容组织原则 - 案例驱动】
...
组织提示：案例要具体，知识引入要自然，避免为了讲案例而案例。""",

    "problem_based": """【内容组织原则 - 问题导向】
...
组织提示：问题要有挑战性，探索过程要真实，避免直接给答案。""",

    "comparative": """【内容组织原则 - 对比分析】
